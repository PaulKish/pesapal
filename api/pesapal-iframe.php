...
*/
$consumer_key = 'jvOnnP5WPEtIXJipcNbC+q0wpQsXvtD/';//Register a merchant account on
                   //demo.pesapal.com and use the merchant key for testing.
                   //When you are ready to go live make sure you change the key to the live account
                   //registered on www.pesapal.com!
$consumer_secret = 'T8+NH7eAS0MH+tJxki1IIS/wnbw=';// Use the secret from your test
...
$callback_url = 'http://localhost/pesapal/response.php'; //redirect url, the page that will handle the response from pesapal.
